...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/adam666
```

A live public deployment of this template is available at [https://adam666.templates.workers.dev](https://adam666.templates.workers.dev)
